...
namespace ArtyVoiceBot.Helpers;

/// <summary>
/// Parses Teams meeting join URLs
/// Based on Sample.Common.Meetings.JoinInfo
/// </summary>
public class JoinInfo
{
    ...
    /// <returns>Parsed ChatInfo and MeetingInfo.</returns>
    public static (ChatInfo, MeetingInfo) ParseJoinURL(string joinURL)
    {
        ...
        using (var stream = new MemoryStream(Encoding.UTF8.GetBytes(match.Groups["context"].Value)))
        {
            ...
            // Set the tenant ID from the meeting URL context
    ...
    /// <summary>
    /// Join URL context embedded in the URL.
    /// </summary>
    [DataContract]
